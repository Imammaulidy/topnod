                ...
                card.innerHTML = `
                    <div class="pad-header" style="min-height: 85px; align-items: flex-start;">
                        <div style="display: flex; flex-direction: column; overflow: hidden; margin-right: 5px;">
                            ...
                            <span class="pad-code" onclick="editPad('${pad}')" style="cursor: pointer; white-space: nowrap;" title="Klik untuk Edit Kode PAD">${shortName} <span style="font-size:0.7em;">&#9998;</span></span>
                            <div class="pad-status" id="status-${pad}" style="margin-top: 5px; text-align: left; min-height: 35px; font-size: 0.8rem; line-height: 1.1; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;">Idle</div>
                        </div>
                        <div style="display: flex; align-items: center; gap: 5px; flex-shrink: 0;">
                            <label style="font-size: 0.75rem; cursor: pointer; display: flex; align-items: center; gap: 3px; white-space: nowrap;">
